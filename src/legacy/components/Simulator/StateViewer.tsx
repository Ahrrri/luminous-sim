...
import { formatNumber, formatTime, formatTimeWithMs } from '../../utils/helpers';
  ...
  return (
    <div className="state-viewer">
      ...
      <div className="damage-info">
        ...
        <div>경과 시간: {formatTimeWithMs(simulation.currentTime)}</div>
        {simulation.inSkillDelay && (
          <div className="delay-info">
            스킬 딜레이: {formatTimeWithMs(simulation.skillDelayEndTime! - simulation.currentTime)} 남음
          </div>
        )}
      </div>
